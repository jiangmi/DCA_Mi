        ...
        for (int b1 = 0; b1 < b::dmn_size(); ++b1) {
            ...
            if (Cluster::REPRESENTATION == domains::MOMENTUM_SPACE) {
               ...
               if ( (b0==0 && b1==1) || (b0==1 && b1==0) || (b0==0 && b1==2)||(b0==2 && b1==0)
                 || (b0==0 && b1==5) || (b0==5 && b1==0) || (b0==0 && b1==6)||(b0==6 && b1==0)
                 || (b0==4 && b1==1) || (b0==1 && b1==4) || (b0==4 && b1==2)||(b0==2 && b1==4)
                 || (b0==4 && b1==5) || (b0==5 && b1==4) || (b0==4 && b1==6)||(b0==6 && b1==4)
                 || (b0==3 && b1==1) || (b0==1 && b1==3) || (b0==7 && b1==5)||(b0==5 && b1==7)
                 || (b0==3 && b1==2) || (b0==2 && b1==3) || (b0==7 && b1==6)||(b0==6 && b1==7)
                 || (b0==3 && b1==5) || (b0==5 && b1==3) || (b0==7 && b1==1)||(b0==1 && b1==7)
                 || (b0==3 && b1==6) || (b0==6 && b1==3) || (b0==7 && b1==2)||(b0==2 && b1==7)) {
