...
#ifndef DCA_PHYS_MODELS_ANALYTIC_HAMILTONIANS_DPS_MODEL_LATTICE_HPP
#define DCA_PHYS_MODELS_ANALYTIC_HAMILTONIANS_DPS_MODEL_LATTICE_HPP
...
double* dps_model<point_group_type>::initialize_r_DCA_basis() {
...
template <typename point_group_type>
double* dps_model<point_group_type>::initialize_k_DCA_basis() {
...
template <typename point_group_type>
double* dps_model<point_group_type>::initialize_r_LDA_basis() {
...
template <typename point_group_type>
double* dps_model<point_group_type>::initialize_k_LDA_basis() {
...
template <typename point_group_type>
std::vector<int> dps_model<point_group_type>::get_flavors() {
...
template <typename point_group_type>
std::vector<std::vector<double>> dps_model<point_group_type>::get_a_vectors() {
...
template <typename point_group_type>
std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> dps_model<
...
template <typename point_group_type>
template <typename BandDmn, typename SpinDmn, typename RDmn, typename parameters_type>
void dps_model<point_group_type>::initialize_H_interaction(
    func::function<double, func::dmn_variadic<func::dmn_variadic<BandDmn, SpinDmn>,
                                              func::dmn_variadic<BandDmn, SpinDmn>, RDmn>>& H_interaction,
    const parameters_type& parameters) {
  if (BandDmn::dmn_size() != BANDS)
    throw std::logic_error("dps model has four bands.");
...
template <typename point_group_type>
template <class domain>
void dps_model<point_group_type>::initialize_H_symmetry(
...
template <typename point_group_type>
template <typename ParametersType, typename ScalarType, typename BandDmn, typename SpinDmn, typename KDmn>
void dps_model<point_group_type>::initialize_H_0(
    const ParametersType& parameters,
    func::function<ScalarType, func::dmn_variadic<func::dmn_variadic<BandDmn, SpinDmn>,
                                                  func::dmn_variadic<BandDmn, SpinDmn>, KDmn>>& H_0) {
  if (BandDmn::dmn_size() != BANDS)
...
#endif  // DCA_PHYS_MODELS_ANALYTIC_HAMILTONIANS_DPS_MODEL_LATTICE_HPP
