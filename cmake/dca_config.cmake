...
set(DCA_LATTICE "square" CACHE STRING
    "Lattice type, options are: bilayer | trilayer | dsmodel | square | threeband | dpsNimodel | triangular | twoband_chain | singleband_chain.")
set_property(CACHE DCA_LATTICE PROPERTY STRINGS bilayer trilayer dsmodel square threeband dpsNimodel triangular twoband_chain singleband_chain)
...
elseif (DCA_LATTICE STREQUAL "singleband_chain")
  ...
  message(FATAL_ERROR
          "Please set DCA_LATTICE to a valid option: bilayer | trilayer | dsmodel | square | threeband | dpsNimodel | triangular | twoband_chain | singleband_chain.")
endif()
