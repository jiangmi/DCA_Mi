...
set(DCA_LATTICE "square" CACHE STRING
    "Lattice type, options are: bilayer | trilayer | dsmodel | square | threeband |  ani3band | bilayer_3band | dpsNimodel | dps_model | dps_3D_model| ddp_model | triangular | twoband_chain | singleband_chain.")
set_property(CACHE DCA_LATTICE PROPERTY STRINGS bilayer trilayer dsmodel square threeband ani3band bilayer_3band dpsNimodel dps_model dps_3D_model ddp_model triangular twoband_chain singleband_chain)
...
elseif (DCA_LATTICE STREQUAL "ani3band")
  set(DCA_LATTICE_TYPE dca::phys::models::ani3band_hubbard<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/ani3band_hubbard.hpp")

elseif (DCA_LATTICE STREQUAL "bilayer_3band")
...
elseif (DCA_LATTICE STREQUAL "dps_3D_model")
  set(DCA_LATTICE_TYPE dca::phys::models::dps_3D_model<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/dps_3D_model.hpp")
...
elseif (DCA_LATTICE STREQUAL "singleband_chain")
  ...
  message(FATAL_ERROR
          "Please set DCA_LATTICE to a valid option: bilayer | trilayer | dsmodel | square | threeband | ani3band | bilayer_3band | dpsNimodel | dps_model || dps_3D_model | ddp_model | triangular | twoband_chain | singleband_chain.")
endif()
