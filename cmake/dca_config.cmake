...
set(DCA_LATTICE "square" CACHE STRING
    "Lattice type, options are: bilayer | La3Ni2O7 | bilayer_eg | trilayer | La4Ni3O10 | tetralayer | dsmodel | square | threeband | bilayer_threeband | dpsNimodel | ddp_model | dds_model | triangular | twoband_chain | singleband_chain.")
set_property(CACHE DCA_LATTICE PROPERTY STRINGS bilayer La3Ni2O7 bilayer_eg trilayer tetralayer dsmodel square threeband bilayer_threeband dpsNimodel ddp_model triangular twoband_chain singleband_chain)
...
elseif (DCA_LATTICE STREQUAL "La3Ni2O7")
  set(DCA_LATTICE_TYPE dca::phys::models::La3Ni2O7<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/La3Ni2O7.hpp")

elseif (DCA_LATTICE STREQUAL "bilayer_eg")
  set(DCA_LATTICE_TYPE dca::phys::models::bilayer_eg<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/bilayer_eg.hpp")
    
elseif (DCA_LATTICE STREQUAL "trilayer")
  set(DCA_LATTICE_TYPE dca::phys::models::trilayer_lattice<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/trilayer_lattice.hpp")

elseif (DCA_LATTICE STREQUAL "La4Ni3O10")
  set(DCA_LATTICE_TYPE dca::phys::models::La4Ni3O10<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/La4Ni3O10.hpp")

elseif (DCA_LATTICE STREQUAL "tetralayer")
  set(DCA_LATTICE_TYPE dca::phys::models::tetralayer_lattice<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/tetralayer_lattice.hpp")

elseif (DCA_LATTICE STREQUAL "dsmodel")
  set(DCA_LATTICE_TYPE dca::phys::models::dsmodel_lattice<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/dsmodel_lattice.hpp")
...
elseif (DCA_LATTICE STREQUAL "ddp_model")
  ...
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/ddp_model.hpp")

elseif (DCA_LATTICE STREQUAL "dds_model")
  set(DCA_LATTICE_TYPE dca::phys::models::dds_model<PointGroup>)
  set(DCA_LATTICE_INCLUDE
    "dca/phys/models/analytic_hamiltonians/dds_model.hpp")
...
elseif (DCA_LATTICE STREQUAL "singleband_chain")
  ...
  message(FATAL_ERROR
          "Please set DCA_LATTICE to a valid option: bilayer | La3Ni2O7 | bilayer_eg | trilayer | La4Ni3O10 | tetralayer | dsmodel | square | threeband | bilayer_threeband | dpsNimodel | ddp_model | dds_model | triangular | twoband_chain | singleband_chain.")
endif()
