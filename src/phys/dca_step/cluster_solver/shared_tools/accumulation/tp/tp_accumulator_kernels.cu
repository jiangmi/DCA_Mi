...
__global__ void updateG4Kernel(CudaComplex<Real>* __restrict__ G4,
  ...
  switch (type) {
    case PARTICLE_HOLE_TRANSVERSE: {
      ...
      if ((conj_a == 1) && ( (b1==0 && b4==1) || (b1==1 && b4==0) || (b1==0 && b4==2)||(b1==2 && b4==0)
                          || (b1==0 && b4==4) || (b1==4 && b4==0) || (b1==0 && b4==5)||(b1==5 && b4==0)
                          || (b1==3 && b4==1) || (b1==1 && b4==3) || (b1==3 && b4==2)||(b1==2 && b4==3)
                          || (b1==3 && b4==4) || (b1==4 && b4==3) || (b1==3 && b4==5)||(b1==5 && b4==3)))
           {sign = -1.0;}
      else {sign = 1.0;}

      const CudaComplex<Real> Ga_1 = sign * cond_conj(G_up[i_a + ldgu * j_a], conj_a);
      const CudaComplex<Real> Ga_2 = sign * cond_conj(G_down[i_a + ldgd * j_a], conj_a);
      ...
      if ((conj_b == 1) && ( (b2==0 && b3==1) || (b2==1 && b3==0) || (b2==0 && b3==2)||(b2==2 && b3==0)
                          || (b2==0 && b3==4) || (b2==4 && b3==0) || (b2==0 && b3==5)||(b2==5 && b3==0)
                          || (b2==3 && b3==1) || (b2==1 && b3==3) || (b2==3 && b3==2)||(b2==2 && b3==3)
                          || (b2==3 && b3==4) || (b2==4 && b3==3) || (b2==3 && b3==5)||(b2==5 && b3==3)))
           {sign = -1.0;}
      else {sign = 1.0;}
      ...
      if ((b2==0 && b3==1) || (b2==1 && b3==0) || (b2==0 && b3==2)||(b2==2 && b3==0)
       || (b2==0 && b3==4) || (b2==4 && b3==0) || (b2==0 && b3==5)||(b2==5 && b3==0)
       || (b2==3 && b3==1) || (b2==1 && b3==3) || (b2==3 && b3==2)||(b2==2 && b3==3)
       || (b2==3 && b3==4) || (b2==4 && b3==3) || (b2==3 && b3==5)||(b2==5 && b3==3)) {
    ...
    case PARTICLE_HOLE_MAGNETIC: {
      ...
      const CudaComplex<Real> Gb_1 = sign * cond_conj(G_up[i_b + ldgu * j_b], conj_b);
      const CudaComplex<Real> Gb_2 = sign * cond_conj(G_down[i_b + ldgd * j_b], conj_b);
      ...
      // new scope to reuse local index variables
      {
        ...
        if ((conj_a == 1) && ( (b1==0 && b3==1) || (b1==1 && b3==0) || (b1==0 && b3==2)||(b1==2 && b3==0)
                            || (b1==0 && b3==4) || (b1==4 && b3==0) || (b1==0 && b3==5)||(b1==5 && b3==0)
                            || (b1==3 && b3==1) || (b1==1 && b3==3) || (b1==3 && b3==2)||(b1==2 && b3==3)
                            || (b1==3 && b3==4) || (b1==4 && b3==3) || (b1==3 && b3==5)||(b1==5 && b3==3)))
             {sign = -1.0;}
        else {sign = 1.0;}

        const CudaComplex<Real> Ga =
            sign * cond_conj(G_up[i_a + ldgu * j_a] - G_down[i_a + ldgd * j_a], conj_a);
        ...
        if ((conj_b == 1) && ( (b2==0 && b4==1) || (b2==1 && b4==0) || (b2==0 && b4==2)||(b2==2 && b4==0)
                            || (b2==0 && b4==4) || (b2==4 && b4==0) || (b2==0 && b4==5)||(b2==5 && b4==0)
                            || (b2==3 && b4==1) || (b2==1 && b4==3) || (b2==3 && b4==2)||(b2==2 && b4==3)
                            || (b2==3 && b4==4) || (b2==4 && b4==3) || (b2==3 && b4==5)||(b2==5 && b4==3)))
             {sign = -1.0;}
         else {sign = 1.0;}

        const CudaComplex<Real> Gb =
            sign * cond_conj(G_up[i_b + ldgu * j_b] - G_down[i_b + ldgd * j_b], conj_b);
    ...
    case PARTICLE_HOLE_LONGITUDINAL_UP_UP: {
      ...
      const CudaComplex<Real> Gb_1 = sign * cond_conj(G_up[i_b + ldgd * j_b], conj_b);
      const CudaComplex<Real> Gb_2 = sign * cond_conj(G_down[i_b + ldgu * j_b], conj_b);
    ...
    case PARTICLE_PARTICLE_UP_DOWN: {
      ...
      if ((conj_a == 1) && ( (b1==0 && b3==1) || (b1==1 && b3==0) || (b1==0 && b3==2)||(b1==2 && b3==0)
                 || (b1==0 && b3==5) || (b1==5 && b3==0) || (b1==0 && b3==6)||(b1==6 && b3==0)
                 || (b1==4 && b3==1) || (b1==1 && b3==4) || (b1==4 && b3==2)||(b1==2 && b3==4)
                 || (b1==4 && b3==5) || (b1==5 && b3==4) || (b1==4 && b3==6)||(b1==6 && b3==4)
                 || (b1==3 && b3==1) || (b1==1 && b3==3) || (b1==7 && b3==5)||(b1==5 && b3==7)
                 || (b1==3 && b3==2) || (b1==2 && b3==3) || (b1==7 && b3==6)||(b1==6 && b3==7)
                 || (b1==3 && b3==5) || (b1==5 && b3==3) || (b1==7 && b3==1)||(b1==1 && b3==7)
                 || (b1==3 && b3==6) || (b1==6 && b3==3) || (b1==7 && b3==2)||(b1==2 && b3==7)))
           {sign = -1.0;}
      else {sign = 1.0;}
      ...
      if ((conj_b == 1) && ( (b2==0 && b4==1) || (b2==1 && b4==0) || (b2==0 && b4==2)||(b2==2 && b4==0)
                 || (b2==0 && b4==5) || (b2==5 && b4==0) || (b2==0 && b4==6)||(b2==6 && b4==0)
                 || (b2==4 && b4==1) || (b2==1 && b4==4) || (b2==4 && b4==2)||(b2==2 && b4==4)
                 || (b2==4 && b4==5) || (b2==5 && b4==4) || (b2==4 && b4==6)||(b2==6 && b4==4)
                 || (b2==3 && b4==1) || (b2==1 && b4==3) || (b2==7 && b4==5)||(b2==5 && b4==7)
                 || (b2==3 && b4==2) || (b2==2 && b4==3) || (b2==7 && b4==6)||(b2==6 && b4==7)
                 || (b2==3 && b4==5) || (b2==5 && b4==3) || (b2==7 && b4==1)||(b2==1 && b4==7)
                 || (b2==3 && b4==6) || (b2==6 && b4==3) || (b2==7 && b4==2)||(b2==2 && b4==7)))
           {sign = -1.0;}
      else {sign = 1.0;}
  ...
  // below there is += so that the above switch part does not need +-, use = is enough
  if (atomic)
